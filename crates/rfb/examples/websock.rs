...
use rfb::rfb::{
    ClientMessageDecoder, ColorFormat, ColorSpecification, PixelFormat,
    ProtoVersion, Resolution, SecurityType, SecurityTypes,
};
use rfb::{self, pixel_formats::rgb_888, tungstenite::BinaryWs};

mod shared;
use shared::{build_logger, order_to_shift, ExampleBackend, Image};
